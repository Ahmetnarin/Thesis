...
\begin{figure}[t]
	...
	\end{tikzpicture}
%	\caption[Netzwerkgraph eines $(L+1)$-Schichten.]{Netzwerkgraph eines $(L+1)$-Schichten mit $D$ Eingänge und $C$ Ausgänge. The $l^{\text{th}}$ versteckten Schichten engl. \textit{hidden layer} enthält $m^{(l)}$ versteckten Schichten.}
