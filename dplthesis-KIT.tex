...
%    \section{Aehnliche Arbeiten}\label{sec:Aehnliche Arbeiten} 
     ...
     \subsection{Gemmini: Ein agiles systolic Array Generator}\label{subsec:Gemmini}
     Gemini ist ein agiles systolic Array Generator, der systematische Auswertungen von Deep-Learning Architekturen ermöglicht. Das ist ein Open-Source-Code und ist in Github \footnote{https://github.com/ucb-bar/gemmini} veröffentlicht. Das Gemini-Projekt ist ein Matrix-Multiplikation-Beschleuniger und basiert auf systolic Array Architektur, der einen benutzerdefinierten ASIC-Beschleuniger generiert. \\
     Gemini ist in der Chisel\footnote{Chisel ist eine Hardware-Design-Sprache basiert auf Scala, die die Erzeugung und Wiederverwendung von Schaltkreisen für digitale ASIC- und FPGA-Logikdesigns erleichtert.}-Programiersprache  geschrieben. Eine Systemübersicht ist in \autoref{fig:gemini} dargestellt. Im Bereich von Systolic Array wird eine 2D-Array Matrixmultiplikation durchgeführt und das Innenleben von Gemini Systolic Array \autoref{fig:geminisystolicArray}
     
 
   
      \begin{figure}[h!]
    	\centering
    	\includegraphics[width=12 cm , height= 8 cm]{Bilder/gemini}
    ...
    \end{figure}
      ...
      \begin{figure}[h!]
		\centering
		\includegraphics[width=15 cm , height=8 cm]{Bilder/geminisystolicArray}
		\caption[Gemini  Systolic Array (PEs)]{Hier sieht man das Innenleben von Gemini Systolic-Array mit seinen Verarbeitungseinheiten (PEs) \cite{genc2019gemmini}}
