...
\begin{figure}[h!]
	...
	\caption{Mooresches Gesetz von 1971-2018 \cite{Wikipedia}} 
	\label{fig:moor}
\end{figure}
...
\newpage
	...
	\begin{description}
		\item[Ein-und Ausgänge] Wenn ein Computer ein Bild sieht, dann sieht er nicht wie Menschen \autoref{fig:hunde}, sondern einer Reihe von Pixelwerten und zwar eine Matrix. \autoref{fig:hunde_matrix} Jede dieser Zahlen von Matrix erhält einen Wert zwischen 0 und 255. Die einzelne Zahlen beschreiben die Intensität des Pixels. Diese Zahlen haben keine Bedeutung bei der Bildklassifizierung. Wofür werden dann Pixelwerte gebraucht? Die Idee ist, dass der Computer aus den Pixelwerten die Wahrscheinlichkeit berechnet und entscheidet mithilfe von Wahrscheinlichkeitswert, was in dem Bild zu sehen ist. (z.B. 0.80 Hund, 0.15 Katzen 0.05 Vogel) In diesem Beispiel die Wahrscheinlichkeit bei Hunden ist größer als die anderen und entscheidet das CNN für ''Hunden''.
	\end{description}
...
%\newpage
	...
	Der Hauptvorteil des TPUs mit Systolic Array Architektur ist seine Unkompliziertheit und es ist nur konzentriert auf Matrix Multiplikation. \cite{telesens}
...
%    \section{Aehnliche Arbeiten}\label{sec:Aehnliche Arbeiten} 
     ...
     A und B sind Matrizen, die miteinander multipliziert werden. D ist ein Bias-Vektor
      \begin{figure}[h!]
    	\centering 
    	\includegraphics[width=18 cm , height= 7 cm]{Bilder/gemini}
    ...
    \end{figure}
      ...
      \begin{figure}[h!]
		\centering
		\includegraphics[width=18 cm , height=7 cm]{Bilder/geminisystolicArray}
